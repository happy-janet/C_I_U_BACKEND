...
export class LecturesService {
  ...
  async create(
    createLecturerSignUpDto: CreateLecturerSignUpDto,
    ...
    await sendEmail(
      email,
      'Registration Successful - Reset Password',
      emailText,
      emailHtml,
    );
    ...
    return {
      message:
        'Lecturer registered successfully. A confirmation email has been sent.',
    };
  }

  async setPassword(
    setupPasswordDto: SetInitialPasswordDto,
  ): Promise<{ message: string }> {
