/*
  ...
  - You are about to drop the column `examRules` on the `ManualAssessment` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "ManualAssessment" DROP COLUMN "examRules";
